...
def pitchangle_func(y,beq,bcalc,instrument,whichd=None):
    ...
    """
    #print(len(y[1]))
    #how many pitch angle bins are we looking at?
    #so besquare has same dimensions as y
...
def pitchangle_func2(self,y,beq,bcalc):
    #what is the difference between these two pitch angle equations? i forget
    #this is wrong for mageis
